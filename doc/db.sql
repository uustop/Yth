...
-- 初始数据
INSERT INTO `sys_user` (`user_id`, `username`, `password`, `salt`, `email`, `mobile`, `status`, `create_user_id`, `create_time`) VALUES ('1', 'admin', 'e1153123d7d180ceeb820d577ff119876678732a68eef4e6ffc0b1f06a01f91b', 'YzcmCZNvbXocrsz9dm8e', 'root@yth.io', '13612345678', '1', '1', '2016-11-11 11:11:11');
...
-- 代码生成器相关SQL，如果不使用yth-gen模块，则不用执行下面SQL -------------------------------------------------------------------------------------------------------------
...
INSERT INTO `schedule_job` (`bean_name`, `method_name`, `params`, `cron_expression`, `status`, `remark`, `create_time`) VALUES ('testTask', 'test', 'yth', '0 0/30 * * * ?', '0', '有参数测试', '2016-12-01 23:16:46');
